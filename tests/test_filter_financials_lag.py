...
class TestFilterFinancialsLag:
    def test_quarterly_lag_45_days(self):
        ...
        # 2024-09-30 Q3 filing ~ mid-Nov; cutoff 2024-11-15 - 45d = 2024-10-01 keeps Q2 and earlier
        filtered = filter_financials_by_date(data, "2024-11-15", statement_type="quarterly")
